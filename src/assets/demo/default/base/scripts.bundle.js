...
var mLayout = function() {
    ...
    return {
        ...
        initHeader: function() {
            ...
            // initQuicksearch();
            initScrollTop();
            if(!$('body').hasClass('m-aside-left--enabled')){       //console.log('in quick start')
                $('.m-stack__item.m-stack__item--middle.m-brand__tools').hide();
                $('a.m-brand__logo-wrapper img').attr('src', './assets/app/media/img/logos/developer2.png').css('width', '250px');
            }else{
                $('.m-stack__item.m-stack__item--middle.m-brand__tools').show();
            }
        },
